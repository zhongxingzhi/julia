...
let str = "1996/02/15 24:00", format = "yyyy/mm/dd HH:MM"
    ...
    #@test_throws ArgumentError Dates.parse(str, DateFormat(format))
    @test_throws ArgumentError Dates.DateTime(str, DateFormat(format))
end

# Issue #13644: Ensure that Dates.parse returns a Period array when no custom slots are used.
#@test eltype(Dates.parse("1942-12-25T01:23:45", DateFormat("yyyy-mm-ddTHH:MM:SS", "english"))) == Dates.Period
...
@test format(dt,"yy-m-dd") == a1
a2 = "96-1-1"
@test Dates.DateTime(a2,f) + Dates.Year(1900) + Dates.Day(14) == dt
@test format(dt-Dates.Day(14),"yy-m-d") == a2
a3 = "1996-1-15"
@test Dates.DateTime(a3,f) == dt
@test format(dt,"yyyy-m-d") == a3
a4 = "1996-Jan-15"
...
@test format(dt+Dates.Month(1),f) == b
b1 = "1996/Feb/15"
@test Dates.DateTime(b1,f) == dt + Dates.Month(1)
@test format(dt+Dates.Month(1),"yyyy/uuu/dd") == b1
b2 = "96/Feb/1"
@test Dates.DateTime(b2,f) + Dates.Year(1900) + Dates.Day(14) == dt + Dates.Month(1)
@test format(dt+Dates.Month(1)-Dates.Day(14),"yy/uuu/d") == b2
...
@test format(dt,"yy,uuu,dd") == d1
d2 = "1996,Jan,1"
@test Dates.DateTime(d2,f) + Dates.Day(14) == dt
@test format(dt-Dates.Day(14),"yyyy,uuu,d") == d2
d3 = "1996,2,15"
...
@test format(dt,"yyyy mm dd") == f1
f2 = "1996 1 1"
@test Dates.DateTime(f2,fo) + Dates.Day(14) == dt
@test format(dt-Dates.Day(14),"yyyy m d") == f2

j = "1996-01-15 zzz"
f = "yyyy-mm-dd zzz"
@test Dates.DateTime(j,f) == dt
@test format(dt,f) == j
k = "1996-01-15 10:00:00 zzz"
f = "yyyy-mm-dd HH:MM:SS zzz"
@test Dates.DateTime(k,f) == dt + Dates.Hour(10)
@test format(dt+Dates.Hour(10),f) == k
l = "1996-01-15 10:10:10.25 zzz"
...
@test format(dt+Dates.Hour(10)+Dates.Minute(10)+Dates.Second(10)+Dates.Millisecond(250),f) == l
...
@test format(dt+Dates.Hour(10),f) == v
w = "1996-01-15T10:00:00 zzz"
f = "yyyy-mm-ddTHH:MM:SS zzz"
@test Dates.DateTime(w,f) == dt + Dates.Hour(10)
@test format(dt+Dates.Hour(10),f) == w
...
@test format(dt-Dates.Day(10),f) == aa
bb = "5/1/1996"
f = "d/m/yyyy"
@test Dates.DateTime(bb,f) == dt - Dates.Day(10)
@test format(dt-Dates.Day(10),f) == bb
cc = "01151996"
f = "mmddyyyy"
...
@test format(Dates.Date(2009,12,1),"yyyy年mm月dd日") == "2009年12月01日"
...
@test format(Dates.Date(2014,5,28),f;locale="french") == "28 mai 2014"
@test Dates.Date("28 févr 2014",f;locale="french") == Dates.Date(2014,2,28)
@test format(Dates.Date(2014,2,28),f;locale="french") == "28 févr 2014"
@test Dates.Date("28 août 2014",f;locale="french") == Dates.Date(2014,8,28)
@test format(Dates.Date(2014,8,28),f;locale="french") == "28 août 2014"
@test Dates.Date("28 avril 2014",f;locale="french") == Dates.Date(2014,4,28)
@test format(Dates.Date(2014,4,28),f;locale="french") == "28 avril 2014"
...
@test format(Dates.Date(2009,12,1),f) == "01Dec09"
f = "dduuuyyyy"
@test Dates.Date("01Dec2009",f) == Dates.Date(2009,12,1)
@test format(Dates.Date(2009,12,1),f) == "01Dec2009"
f = "duy"
...
@test format(Dates.Date(2014,1,1),f;locale="globex") == "1F4"
...
@test_throws ArgumentError Dates.Date("1 2",f) == Dates.Date(1,2)
